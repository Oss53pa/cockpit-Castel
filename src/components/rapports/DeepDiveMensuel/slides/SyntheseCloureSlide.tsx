...
// Ce qui va bien + Points de vigilance + Décisions du jour + Prochain Deep Dive
// ============================================================================
...
export function SyntheseCloureSlide({ data, designSettings }: SyntheseCloureSlideProps) {
  ...
  const { pointsPositifs, pointsVigilance, decisionsJour, prochainDeepDive } = data;
  ...
  return (
    <div style={{ fontFamily }} className="h-full flex flex-col bg-white">
      ...
      <div className="flex-1 p-4 overflow-auto grid grid-cols-2 gap-4">
        ...
        {/* BOTTOM RIGHT: Prochain Deep Dive */}
        <div
          ...
          <div className="space-y-3 text-center">
            <div>
              ...
              <div className="text-2xl font-bold" style={{ color: primaryColor }}>
                {new Date(prochainDeepDive.date).toLocaleDateString('fr-FR', {
                  weekday: 'long',
                  day: 'numeric',
                  month: 'long',
                  year: 'numeric'
            ...
            <div>
              ...
              <div className="text-xl font-semibold" style={{ color: primaryColor }}>
                {prochainDeepDive.heure}
              </div>
            </div>
            {prochainDeepDive.focusParticulier && (
              <div
