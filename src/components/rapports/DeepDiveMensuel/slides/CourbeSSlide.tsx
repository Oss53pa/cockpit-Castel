...
import type { CourbeSData } from '@/types/deepDive';
            ...
            <div className="mt-4 p-3 bg-gray-100 rounded-lg">
              ...
              <div className="space-y-1 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">{formatMontant(data.budgetTotal)} FCFA</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">Consommé:</span>
                  <span className="font-medium text-green-600">{formatMontant(data.budgetConsomme)} FCFA</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">Engagé:</span>
                  <span className="font-medium text-amber-600">{formatMontant(data.budgetEngage)} FCFA</span>
                </div>
                <div className="flex justify-between border-t pt-1 mt-1">
                  <span className="text-gray-600">Reste:</span>
                  <span className="font-bold" style={{ color: primaryColor }}>
                    {formatMontant(data.budgetTotal - data.budgetConsomme - data.budgetEngage)} FCFA
                  </span>
                </div>
              </div>
            </div>
