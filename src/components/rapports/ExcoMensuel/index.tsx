// ============================================================================
// EXCO MENSUEL V2 - COMPOSANT PRINCIPAL
...
import {
  EXCO_MENSUEL_SECTIONS,
  toggleSlideInclusion,
  updateSlideComment,
  toggleSectionExpanded,
  countActiveSlides,
} from '@/data/excoMensuelTemplate';
import { useCurrentSite, useUsers } from '@/hooks';
import { PROJET_CONFIG } from '@/data/constants';
import { useExcoMensuelData } from './hooks/useExcoMensuelData';
...
interface ExcoMensuelProps {
  designSettings: ExcoDesignSettings;
  onDesignSettingsChange?: (settings: ExcoDesignSettings) => void;
...
export function ExcoMensuel({
  ...
  // State
  const [sections, setSections] = useState<ExcoMensuelSection[]>(
    EXCO_MENSUEL_SECTIONS
  );
  ...
  const ROLE_TITRES: Record<string, string> = { admin: 'SDR', manager: 'Consultant', viewer: 'Lecteur' };
