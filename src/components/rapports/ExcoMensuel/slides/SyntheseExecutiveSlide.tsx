...
import type { MeteoGlobaleData, FaitsMarquantsData, MeteoNiveau, TendanceType } from '@/types/exco';
import { METEO_EMOJI_CONFIG } from '@/types/exco';
import { formatCompteRebours, getJoursRestants, JALONS_CLES_COMPTE_REBOURS, METEO_LABELS } from '@/data/excoMensuelTemplate';
