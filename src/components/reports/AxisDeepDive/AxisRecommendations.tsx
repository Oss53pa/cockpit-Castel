  ...
  const recommendations = useMemo(() => {
    ...
    if (risquesCritiques.length > 0) {
      recs.push({
        ...
        description: `Des risques à score élevé (≥12) menacent l'axe.`,
    ...
    const actionsTermineesRecemment = actions.filter(a => {
      ...
      return dateReelle >= sevenDaysAgo;
    });

    if (actionsTermineesRecemment.length >= 3) {
      recs.push({
        id: 'bonne-dynamique',
        type: 'success',
