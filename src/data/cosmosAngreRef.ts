...
export const JALONS_GLOBAUX = [
  { id: 'J-001', titre: 'Kick-off projet Cosmos Angré', date: '2026-02-09', responsable: RESPONSABLES.SDR, axe: 'global', critique: true, dependances: [] },
  { id: 'J-002', titre: 'Validation organigramme cible', date: '2026-01-31', responsable: RESPONSABLES.SDR, axe: 'axe1_rh', critique: true, dependances: ['J-001'] },
  { id: 'J-003', titre: 'Plan de commercialisation validé', date: '2026-02-28', responsable: RESPONSABLES.SDR, axe: 'axe2_commercial', critique: true, dependances: ['J-002'] },
  { id: 'J-004', titre: 'Budget projet consolidé approuvé', date: '2026-02-15', responsable: RESPONSABLES.SDR, axe: 'axe4_budget', critique: true, dependances: ['J-001'] },
  { id: 'J-005', titre: 'Stratégie communication validée', date: '2026-03-15', responsable: RESPONSABLES.SDR, axe: 'axe5_marketing', critique: false, dependances: ['J-003'] },
  { id: 'J-006', titre: 'Soft Opening', date: '2026-10-16', responsable: RESPONSABLES.SDR, axe: 'global', critique: true, dependances: ['all'] },
  { id: 'J-007', titre: 'Inauguration officielle', date: '2026-11-15', responsable: RESPONSABLES.SDR, axe: 'global', critique: true, dependances: ['J-006'] },
];

// 1.2 JALONS AXE 1 : RH & ORGANISATION (J1-001 à J1-010)
export const JALONS_AXE1 = [
  { id: 'J1-001', titre: 'Organigramme cible validé', date: '2026-01-31', responsable: RESPONSABLES.SDR, axe: 'axe1_rh', critique: true, livrables: 'Organigramme, fiches de poste' },
  { id: 'J1-002', titre: 'Center Manager recruté', date: '2026-02-28', responsable: RESPONSABLES.SDR, axe: 'axe1_rh', critique: true, livrables: 'Contrat signé' },
  { id: 'J1-003', titre: 'Commercial Manager recruté', date: '2026-03-15', responsable: RESPONSABLES.SDR, axe: 'axe1_rh', critique: true, livrables: 'Contrat signé' },
  { id: 'J1-004', titre: 'Facility Manager recruté', date: '2026-03-31', responsable: RESPONSABLES.SDR, axe: 'axe1_rh', critique: true, livrables: 'Contrat signé' },
  { id: 'J1-005', titre: 'Security Manager recruté', date: '2026-03-31', responsable: RESPONSABLES.SDR, axe: 'axe1_rh', critique: true, livrables: 'Contrat signé' },
  { id: 'J1-006', titre: 'Marketing Manager recruté', date: '2026-04-15', responsable: RESPONSABLES.SDR, axe: 'axe1_rh', critique: false, livrables: 'Contrat signé' },
...
export const JALONS_AXE2_GLOBAL = [
  { id: 'J2-001', titre: 'Plan de commercialisation finalisé', date: '2026-02-28', responsable: RESPONSABLES.SDR, axe: 'axe2_commercial', critique: true },
  { id: 'J2-002', titre: 'Grille tarifaire validée', date: '2026-02-15', responsable: RESPONSABLES.SDR, axe: 'axe2_commercial', critique: true },
  ...
  { id: 'J2-006', titre: 'Locomotive alimentaire signée', date: '2026-03-31', responsable: RESPONSABLES.SDR, axe: 'axe2_commercial', critique: true, cible: 'Carrefour' },
...
export const JALONS_AXE2_CC = [
  ...
  { id: 'J2-CC-004', titre: 'Anchor tenant alimentaire confirmé', date: '2026-03-31', responsable: RESPONSABLES.SDR, axe: 'axe2_commercial', buildingCode: 'CC', detail: 'Carrefour' },
...
export const JALONS_AXE2_ZE = [
  { id: 'J2-ZE-001', titre: 'Concept Zone Expo validé', date: '2026-03-31', responsable: RESPONSABLES.SDR, axe: 'axe2_commercial', buildingCode: 'ZE', detail: 'Plan exploitation' },
...
export const JALONS_AXE2_MA = [
  { id: 'J2-MA-001', titre: 'Concept marché validé', date: '2026-02-28', responsable: RESPONSABLES.SDR, axe: 'axe2_commercial', buildingCode: 'MA', detail: 'Cahier des charges' },
...
export const JALONS_AXE2_PK = [
  { id: 'J2-PK-001', titre: 'Politique tarifaire parking validée', date: '2026-03-31', responsable: RESPONSABLES.SDR, axe: 'axe2_commercial', buildingCode: 'PK', detail: 'Grille tarifs' },
  { id: 'J2-PK-002', titre: 'Contrat exploitation parking signé', date: '2026-06-30', responsable: RESPONSABLES.SDR, axe: 'axe2_commercial', buildingCode: 'PK', detail: 'Opérateur ou interne' },
...
export const JALONS_AXE4 = [
  { id: 'J4-001', titre: 'Budget projet consolidé validé', date: '2026-02-15', responsable: RESPONSABLES.SDR, axe: 'axe4_budget', critique: true },
  { id: 'J4-002', titre: 'Plan de trésorerie validé', date: '2026-02-28', responsable: RESPONSABLES.FINANCE, axe: 'axe4_budget', critique: true },
  { id: 'J4-003', titre: 'Contrats prestataires principaux signés', date: '2026-03-31', responsable: RESPONSABLES.SDR, axe: 'axe4_budget', critique: true },
  ...
  { id: 'J4-007', titre: 'Budget exploitation 2027 validé', date: '2026-11-30', responsable: RESPONSABLES.SDR, axe: 'axe4_budget', critique: true },
...
export const JALONS_AXE5 = [
  ...
  { id: 'J5-010', titre: 'Soft Opening réussi', date: '2026-10-16', responsable: RESPONSABLES.SDR, axe: 'axe5_marketing', critique: true },
  { id: 'J5-011', titre: 'Inauguration officielle réussie', date: '2026-11-15', responsable: RESPONSABLES.SDR, axe: 'axe5_marketing', critique: true },
];
...
export const JALONS_AXE6 = [
  ...
  { id: 'J6-011', titre: 'Commission de sécurité - Avis favorable', date: '2026-11-10', responsable: RESPONSABLES.SDR, axe: 'axe6_exploitation', critique: true },
];
...
export const ACTIONS_AXE1 = [
  { id: 'A1-001', titre: 'Finaliser organigramme cible Cosmos Angré', dateDebut: '2026-01-15', dateFin: '2026-01-31', responsable: RESPONSABLES.SDR, priorite: 'critique' as Priorite, statut: 'a_faire' },
  { id: 'A1-002', titre: 'Valider fiches de poste managers', dateDebut: '2026-01-20', dateFin: '2026-02-05', responsable: RESPONSABLES.SDR, priorite: 'critique' as Priorite, statut: 'a_faire' },
  { id: 'A1-003', titre: 'Lancer recrutement Center Manager', dateDebut: '2026-02-01', dateFin: '2026-02-28', responsable: RESPONSABLES.SDR, priorite: 'critique' as Priorite, statut: 'a_faire' },
  { id: 'A1-004', titre: 'Lancer recrutement Commercial Manager', dateDebut: '2026-02-15', dateFin: '2026-03-15', responsable: RESPONSABLES.SDR, priorite: 'critique' as Priorite, statut: 'a_faire' },
  { id: 'A1-005', titre: 'Lancer recrutement Facility Manager', dateDebut: '2026-03-01', dateFin: '2026-03-31', responsable: RESPONSABLES.SDR, priorite: 'critique' as Priorite, statut: 'a_faire' },
  { id: 'A1-006', titre: 'Lancer recrutement Security Manager', dateDebut: '2026-03-01', dateFin: '2026-03-31', responsable: RESPONSABLES.SDR, priorite: 'critique' as Priorite, statut: 'a_faire' },
  { id: 'A1-007', titre: 'Lancer recrutement Marketing Manager', dateDebut: '2026-03-15', dateFin: '2026-04-15', responsable: RESPONSABLES.SDR, priorite: 'haute' as Priorite, statut: 'a_faire' },
...
export const ACTIONS_AXE2_STRATEGIQUES = [
  { id: 'A2-001', titre: 'Finaliser plan de commercialisation', dateDebut: '2026-02-01', dateFin: '2026-02-28', responsable: RESPONSABLES.SDR, priorite: 'critique' as Priorite },
  { id: 'A2-002', titre: 'Valider grille tarifaire par zone', dateDebut: '2026-02-01', dateFin: '2026-02-15', responsable: RESPONSABLES.SDR, priorite: 'critique' as Priorite },
  ...
  { id: 'A2-005', titre: 'Négocier avec Carrefour', dateDebut: '2026-02-01', dateFin: '2026-03-31', responsable: RESPONSABLES.SDR, priorite: 'critique' as Priorite },
];
...
export const ACTIONS_AXE2_MA = [
  { id: 'A2-MA-001', titre: 'Définir cahier des charges Marché Artisanal', dateFin: '2026-02-28', responsable: RESPONSABLES.SDR, priorite: 'haute' as Priorite, buildingCode: 'MA' },
...
export const ACTIONS_AXE2_PK = [
  { id: 'A2-PK-001', titre: 'Définir politique tarifaire parking', dateFin: '2026-03-31', responsable: RESPONSABLES.SDR, priorite: 'haute' as Priorite, buildingCode: 'PK' },
  { id: 'A2-PK-002', titre: 'Évaluer options exploitation (interne/externe)', dateFin: '2026-04-30', responsable: RESPONSABLES.SDR, priorite: 'haute' as Priorite, buildingCode: 'PK' },
  { id: 'A2-PK-003', titre: 'Négocier contrat opérateur parking (si externe)', dateFin: '2026-06-30', responsable: RESPONSABLES.SDR, priorite: 'haute' as Priorite, buildingCode: 'PK' },
