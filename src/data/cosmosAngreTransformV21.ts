...
function transformJalonV21(refJalon: JalonV21): Omit<Jalon, 'id'> {
  ...
  return {
    ...
    validateur: RESPONSABLES_V21.SDR,
    contributeurs: [],
    parties_prenantes: [],
    escalade_niveau1: RESPONSABLES_V21.CENTER_MANAGER,
    escalade_niveau2: RESPONSABLES_V21.SDR,
    escalade_niveau3: RESPONSABLES_V21.SDR,
    ...
    criteres_acceptation: (refJalon.criteres || []).map((crit, idx) => ({
      ...
      validateur: statut === 'atteint' ? RESPONSABLES_V21.SDR : null,
    })),
    budget_associe: null,
...
function transformActionV21(refAction: ActionV21, jalonDbId: number | null): Omit<Action, 'id'> {
  ...
  return {
    ...
    approbateur: RESPONSABLES_V21.SDR,
    consultes: [],
    informes: [],
    delegue: null,
    escalade_niveau1: RESPONSABLES_V21.CENTER_MANAGER,
    ...
    validateur_qualite: RESPONSABLES_V21.SDR,
    documents: [],
    lien_sharepoint: null,
