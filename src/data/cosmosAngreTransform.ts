...
function transformAction(refAction: {
  ...
  return {
    ...
    approbateur: RESPONSABLES.SDR,
    consultes: [],
    informes: [],
    delegue: null,
    escalade_niveau1: RESPONSABLES.CENTER_MANAGER,
    escalade_niveau2: RESPONSABLES.SDR,
    escalade_niveau3: RESPONSABLES.SDR,
    predecesseurs: [],
    successeurs: [],
    ...
    validateur_qualite: RESPONSABLES.SDR,
    documents: [],
